...
use flow_lenia::{
    ...
    schema::{PopulationConfig, EvaluationConfig, SimulationConfig, GeneticAlgorithmConfig, SearchAlgorithm, SelectionMethod},
};
...
fn main() {
    ...
    for pop_size in [10, 20, 40, 80] {
        ...
        println!("Population {}: {} evals in {:.2}s ({:.1} evals/sec)", 
            pop_size, total_evals, elapsed.as_secs_f64(), evals_per_sec);
    }
}
