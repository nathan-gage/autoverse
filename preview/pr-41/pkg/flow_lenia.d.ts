...
export class WasmEvolutionEngine {
  ...
  setDefaultSeed(seed_json: string): void;
  getPopulationSize(): number;
  getBestCandidateState(): any;
...
export interface InitOutput {
  ...
  readonly __wbg_wasmevolutionengine_free: (a: number, b: number) => void;
  readonly __wbg_wasmgpupropagator_free: (a: number, b: number) => void;
  readonly __wbg_wasmpropagator_free: (a: number, b: number) => void;
  readonly wasmevolutionengine_cancel: (a: number) => void;
  readonly wasmevolutionengine_getArchiveSize: (a: number) => number;
  readonly wasmevolutionengine_getBestCandidateState: (a: number) => [number, number, number];
  readonly wasmevolutionengine_getBestFitness: (a: number) => number;
  readonly wasmevolutionengine_getGeneration: (a: number) => number;
  readonly wasmevolutionengine_getPopulationSize: (a: number) => number;
  readonly wasmevolutionengine_getResult: (a: number) => [number, number, number];
  readonly wasmevolutionengine_isComplete: (a: number) => number;
  readonly wasmevolutionengine_new: (a: number, b: number) => [number, number, number];
  readonly wasmevolutionengine_setDefaultSeed: (a: number, b: number, c: number) => [number, number];
  readonly wasmevolutionengine_step: (a: number) => [number, number, number];
